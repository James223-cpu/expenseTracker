...
<template>
  <div class="justify-center items-center h-full">
    <div>
      <h1 class="m-5 text-3xl text-white">Expense Tracker</h1>

      <div class="flex flex-col justify-center mx-auto md:flex-row bg-green-500 bg-opacity-5">
        <div
          class="lg:w-1/3 m-3 p-3 border border-slate-500 rounded bg-gray-100" style="height: 700px">
          <form
        ...
        <div class="lg:w-2/3 m-3" style="height: 450px; width: 100% ">
          <div>
            <table class="scrolldown">
              <thead>
                <tr>
                  <th class="px-3 py-2 font-thin border bg-blue-400">Date & Time</th>
                  <th class="px-3 py-2 font-thin border bg-blue-400">Item</th>
                  <th class="px-3 py-2 font-thin border bg-blue-400">Category</th>
                  <th class="px-3 py-2 font-thin border bg-blue-400">Amount</th>
                  <th class="px-3 py-2 font-thin border bg-blue-400">Edit</th>
                </tr>
              </thead>
              <tbody>
                <tr v-for="expense in expenses" :key="expense.id">
                  <td class="px-3 py-2 border nowrap bg-green-400">
                  ...
                  <td class="px-3 py-2 border text-center bg-green-400">
              ...
              <tfoot>
                <tr>
                  <td class="px-3 py-6 border-1 bg-red-600 font-bold">
...
<style>
body {
   background-image: url(https://kosmospublishers.com/wp-content/uploads/2018/10/statistics-graph-illustration.jpg);
}
table.scrolldown {
  height: 450px;
}
